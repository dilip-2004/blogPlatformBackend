...
async def toggle_like(
    ...
    if existing_like:
        ...
        # Emit socket event for like removed
        await socket_manager.emit_like_update("removed", {
            "blog_id": blog_id,
    ...
    # Emit socket event for like added
    await socket_manager.emit_like_update("added", {
        "blog_id": blog_id,
        "user_id": current_user.id,
        "blog_title": blog.get("title", "")
    })
